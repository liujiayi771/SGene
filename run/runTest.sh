...
${SPARK_HOME}/bin/spark-submit \
        ...
        -n 200 \
        -t ${THREAD} \
        -I /user/spark/data/input/NGS-Spark-Input/test_case_64M \
        -I /user/spark/data/input/NGS-Spark-Input/test_normal_64M \
        ...
        --CA gatk_mutect2=="-L $targetBed --dbsnp $dbsnp_del100 --cosmic $cosmic -contamination 0 --max_alt_alleles_in_normal_count 3 --max_alt_alleles_in_normal_qscore_sum 40 --max_alt_allele_in_normal_fraction 0.02 -dt NONE -ntLib $THREAD"